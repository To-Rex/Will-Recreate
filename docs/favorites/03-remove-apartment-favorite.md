# Remove from Favorites (Apartment)

## API URL
```
DELETE https://dev.weel.uz/api/property/apartments/{property_id}/favorite/
```
...
## cURL Example
```bash
curl -X DELETE "https://dev.weel.uz/api/property/apartments/9c0701aa-434c-47b0-bf51-1fbf51a7528c/favorite/" \
