# Client Registration - Step 2: Verify OTP

## API URL
```
POST https://dev.weel.uz/api/user/client/register/verify/
```
...
## cURL Example
```bash
curl -X POST https://dev.weel.uz/api/user/client/register/verify/ \
